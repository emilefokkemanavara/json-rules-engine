...
OperatorDecorators.push(new OperatorDecorator<unknown, unknown[], unknown, unknown>('someValue', (factValue, jsonValue, next) => jsonValue.some(jv => next(factValue, jv))))
...
OperatorDecorators.push(new OperatorDecorator<unknown, unknown[], unknown, unknown>('everyValue', (factValue, jsonValue, next) => jsonValue.every(jv => next(factValue, jv))))
