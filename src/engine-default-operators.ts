...
Operators.push(new Operator<unknown, unknown[] | string>('in', (a, b) => b.indexOf(a as string) > -1))
Operators.push(new Operator<unknown, unknown[] | string>('notIn', (a, b) => b.indexOf(a as string) === -1))
